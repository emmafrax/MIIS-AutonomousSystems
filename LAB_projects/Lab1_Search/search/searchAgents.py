...
def cornersHeuristic(state, problem):
    ...
    h=0#Init heuristic
    ideal_pos = state[0]#First position current 
    while len(corners_unvisited)>0:#Iterate over our unvisited corners 
        h_c = []
        x,y = ideal_pos#extract x, y coordinates
...
def foodHeuristic(state, problem):
    ...
    return h/len(food_coord) #Return de average 
